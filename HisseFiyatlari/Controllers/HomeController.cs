    ...
    public class HomeController(ApplicationDbContext context) : Controller
    {
        public IActionResult Index(string currency = "TRY")
        {
            ...
            var rawData = context.MarketDatas
                .Where(m => m.SiteType == "HisseFiyatlari" && m.RecordDate >= baslangicTarihi)
                .ToList();
        ...
        public IActionResult Contact(Models.ContactViewModel model)
        {
            ...
            try
            {
                ...
                string toEmail = settings?.ContactEmail ?? "admin@HisseFiyatlari.com";
        ...
        {
            // Sitenin o anki kök adresini (https://www.HisseFiyatlari.com gibi) otomatik alır
